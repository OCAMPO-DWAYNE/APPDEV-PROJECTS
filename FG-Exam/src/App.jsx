...
import KeyboardDetails from './Body';
...
const App = () => {
    const keyboardData = {
        ...
        setupInstructions: "Carefully remove the keyboard and accessories from the box. Plug the USB cable into an available USB port on your computer. The keyboard should be automatically recognized and ready for use.",
        troubleshooting: "Ensure the USB connection is secure. Try connecting the keyboard to a different USB port. Restart your computer if necessary.",
        maintenance: "Disconnect the keyboard from the computer. Use a soft, dry cloth to clean the surface.",
        support: "Warranty Period: 2 years from the date of purchase. Customer Support: For assistance, contact customer support via the manufacturer’s website or call the support hotline at 1-800-555-1234.",
        greet: "Thank you for choosing the KB-X1000. We hope you enjoy your new keyboard! Type Safe!"
    };

    return (
        <div>
            <Header />
            <KeyboardDetails {...keyboardData} />
            <Footer />
        </div>
    );
};
